...
export const ErrorCode = {
  ...
  USER_INVALID_TRANSITION: "USER_INVALID_TRANSITION",

  // OUTBOX_*
  OUTBOX_EVENT_NOT_FOUND: "OUTBOX_EVENT_NOT_FOUND",
  OUTBOX_EVENT_NOT_RETRYABLE: "OUTBOX_EVENT_NOT_RETRYABLE",
  ...
  // Resource-sourced case initiation requests (2026-08-19) — a company can't send this
  // request to itself for a resource its own org already owns.
  DISCOVERY_INITIATION_REQUEST_SELF_TARGET: "DISCOVERY_INITIATION_REQUEST_SELF_TARGET",
