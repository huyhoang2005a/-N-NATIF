...
const ERROR_MESSAGES_VI: Record<string, string> = {
  ...
  AUTH_ORGANIZATION_PENDING_VERIFICATION: "Hồ sơ đăng ký tổ chức của bạn đang chờ quản trị viên duyệt. Vui lòng thử đăng nhập lại sau.",
  AUTH_ORGANIZATION_REJECTED: "Tài khoản của bạn không được duyệt. Vui lòng đăng ký lại và gửi lại giấy tờ xác minh.",
  ...
  CASE_NOT_DELETABLE: "Không thể xoá case này — chỉ xoá được case nháp chưa có bằng chứng nào.",
  ...
  RESOURCE_NOT_DELETABLE: "Không thể xoá tài nguyên này — chỉ xoá được bản nháp chưa có bình chọn, lưu hoặc quyền truy cập nào.",
  ...
  DISCOVERY_INITIATION_REQUEST_SELF_TARGET: "Bạn không thể gửi yêu cầu này cho tài liệu của chính tổ chức mình.",
